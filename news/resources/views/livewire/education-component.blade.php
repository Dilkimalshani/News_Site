                    ...
                    <div class="position-relative mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            @foreach ($posts as $post)
                                <div class="mb-3">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Education</a>
                                ...
                                <img class="img-fluid w-50 float-left mr-4 mb-2" src="{{asset('asset/img/img10.jpg')}}">
                                <p>{{$post->long_desc}}</p>
